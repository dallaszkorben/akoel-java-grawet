...
public class DynamicCompiler {
	...
	private static String classOutputFolder = "bin/demo";
	...
	private static JavaFileObject getJavaFileObject() {
		StringBuilder contents = new StringBuilder("package demo;"
		...
		try {
			so = new InMemoryJavaFileObject("demo.Calculator",contents.toString());
...
//			String classNameToBeLoaded = "demo.Calculator";
//			Class myClass = myClassLoader.loadClass(classNameToBeLoaded);
			
			//Method method = Class.forName("demo.Calculator").getMethod("testAdd");
			...
			Class thisClass = loader.loadClass("demo.Calculator");

...
public enum ListElementTypeOperationsFullListEnum implements ElementTypeOperationsListEnumInterface{		
	...
	COMPARE_TO_CONSTANT( 5, CommonOperations.getTranslation( "editor.label.step.elementtype.list.comparetoconstant") ),
	...
	CONTAIN_CONSTANT( 8, CommonOperations.getTranslation( "editor.label.step.elementtype.list.containsconstant") ),
	...
	public static ListElementTypeOperationsFullListEnum getElementFieldOperationByIndex( int index ){
		...
		case 3: return TAB;
		case 4: return CLICK;
		case 5: return COMPARE_TO_CONSTANT;
		case 6: return COMPARE_TO_STORED;
		case 7: return COMPARE_TO_STRING;
		case 8: return CONTAIN_CONSTANT;

...
public class ParamElementAbsoluteDataModel extends ParamDataModelAdapter {
	
	private static final long serialVersionUID = -8916078747948054716L;

	public static Tag TAG = Tag.PARAMELEMENTABSOLUTE;
	 ...
	 * @param operation
	 */
	public ParamElementAbsoluteDataModel( String name, BaseElementDataModelAdapter baseElement, ElementOperationAdapter operation ){
		this.name = name;
	 ...
	 */
	public ParamElementAbsoluteDataModel( Element element, BaseDataModelAdapter baseDataModel, VariableRootDataModel variableRootDataModel ) throws XMLPharseException{
...
//TODO duplikacio megszuntetese. ugyan ez van a SpecialElementTypeComponent.java-ban is, csak egy kicsit maskent	    
	...
	public Object clone(){
		...
		ParamElementAbsoluteDataModel cloned = (ParamElementAbsoluteDataModel)super.clone();
...
//		cloned.baseElement = (BaseElementDataModel) this.baseElement.clone();
	...
	public Object cloneWithParent() {
		...
		ParamElementAbsoluteDataModel cloned = (ParamElementAbsoluteDataModel) this.clone();

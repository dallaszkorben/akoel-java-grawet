	...
	private void common( ElementTypeListEnum elementType , ElementOperationInterface elementOperation, BaseRootDataModel baseRootDataModel, VariableRootDataModel variableRootDataModel ){
		...
		if( null == elementOperation ){
			...
			if( elementOperation instanceof ClickOperation  ){
				...
				fieldVariableSelector = new VariableTreeSelectorComponent( variableRootDataModel, ((FillVariableOperation)elementOperation).getVariableElement() );
				comboOperationList.setSelectedIndex(E.FILL_VARIABLE.getIndex());

			}else if( elementOperation instanceof FillElementOperation ){
								
				fieldBaseElementSelector = new BaseElementTreeSelectorComponent( baseRootDataModel, ((FillElementOperation)elementOperation).getBaseElement() );

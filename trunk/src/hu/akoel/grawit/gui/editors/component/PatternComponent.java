...
import hu.akoel.grawit.gui.editors.component.treeselector.TreeSelectorComponent;

import javax.swing.ImageIcon;
import javax.swing.tree.TreePath;

public class PatternComponent extends TreeSelectorComponent<BaseElementDataModel>{

	private static final long serialVersionUID = -5178610032767904794L;

	public PatternComponent( BaseDataModelInterface rootDataModel ) {
		super(BaseElementDataModel.class, rootDataModel);
	}

	public PatternComponent( BaseDataModelInterface rootDataModel, BaseElementDataModel selectedBaseElementDataModel ) {

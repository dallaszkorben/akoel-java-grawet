...
public class ConstantTodayDateComponent extends JPanel implements ConstantComponentInterface{
		...
		fieldDateDigression.addItemListener( new ItemListener() {
			...
			public void itemStateChanged(ItemEvent e) {
				...
				if( e.getStateChange() == java.awt.event.ItemEvent.SELECTED ){ 
					...
					ConstantTodayDateComponent.this.remove( labelDays );
					ConstantTodayDateComponent.this.remove( fieldDays );
					...
					if( index == DateDigressionListEnum.PLUS.getIndex() || index == DateDigressionListEnum.MINUS.getIndex() ){
						...
						ConstantTodayDateComponent.this.add( labelDays, c );
						...
						c.weightx = 0;
						c.anchor = GridBagConstraints.WEST;
						ConstantTodayDateComponent.this.add( fieldDays, c );		
						
					}					
					ConstantTodayDateComponent.this.revalidate();					
				}				
			}
		});	

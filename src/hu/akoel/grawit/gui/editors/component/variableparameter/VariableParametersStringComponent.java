...
public class VariableParametersStringComponent extends JPanel implements VariableParametersComponentInterface{
	 ...
	 * @param type
	 */
	public VariableParametersStringComponent( ParameterTypeListEnum type ){
		super();
	 ...
	 * @param parameterList
	 */
	public VariableParametersStringComponent( ParameterTypeListEnum type, ArrayList<Object> parameterList ){
		super();

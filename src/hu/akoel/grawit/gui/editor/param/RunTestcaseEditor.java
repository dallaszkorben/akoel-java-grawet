...
public class RunTestcaseEditor extends DataEditor{
	 ...
	 * @param selectedPage
	 */
	public RunTestcaseEditor( Tree tree, ParamPageDataModel selectedPage, VariableRootDataModel rootDataModel ){
...
//		fieldOperation.setSelectedIndex( 0 );
	 ...
	 * @param mode
	 */
	public RunTestcaseEditor( Tree tree, ParamElementDataModel selectedElement, VariableRootDataModel rootDataModel, EditMode mode ){		
			...
			public void itemStateChanged(ItemEvent e) {
				...
				if( e.getStateChange() == java.awt.event.ItemEvent.SELECTED ){ 
					 ...
					 if( null != fieldParameterElementSelector ){
						 RunTestcaseEditor.this.remove( labelParameterElementSelector, fieldParameterElementSelector.getComponent() );
						 RunTestcaseEditor.this.repaint();
					 }
					 ...
					 if( operation.equals( Operation.FIELD ) ){
						 ...
						 RunTestcaseEditor.this.add( labelParameterElementSelector, fieldParameterElementSelector );
